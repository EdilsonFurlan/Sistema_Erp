...
SECRET_KEY = 'django-insecure-#=z!!(i%4@#hod6mpav0zpp**qw&(w7cc_6x#4&q%bhj-y&2x^'
...
# Media Files (Uploads)
MEDIA_URL = '/media/'
# Default to project folder, but can be changed to external path e.g. "F:/CadMolde_Data/"
